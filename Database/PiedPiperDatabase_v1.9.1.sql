...
INSERT INTO `favourites` VALUES (3,1,4),(NULL,NULL,31),(NULL,NULL,32),(NULL,NULL,33),(NULL,1,34),(NULL,1,35),(NULL,1,36),(NULL,3,37),(NULL,3,38),(NULL,NULL,39),(NULL,NULL,40),(2,3,41),(2,5,42),(2,1,43),(NULL,NULL,44);
...
INSERT INTO `house_information` VALUES (1,'123 Fake Street',3,5,2,200,NULL,'2015-09-03','This is a house that has a door and a few rooms and stuff like that',1,'House',1,-27.683,152.942,41),(2,'82 Hello Drive',6,3,2,535,NULL,'2015-09-03','This house is super cool!',0,'House',1,-27.358,153.132,427),(3,'15 Micko Street',6,6,6,1250,NULL,'2015-09-03','Who could ever want a better house?',1,'House',1,-27.373,153.106,49),(4,'27 Lower Drive',2,7,2,190,NULL,'2015-09-03','This is a small hosue',1,'House',1,-27.572,152.936,2),(5,'32 Franklin Street',3,2,2,220,NULL,'2015-09-03','A house for people who drink Mount Franklin',0,'House',1,-27.437,153.116,7),(6,'77 NotAvailable Road',8,1,1,666,NULL,'2015-10-03','This house is currently being rented and is hidden.',1,'Apartment',0,-27.531,153.013,0);
...
INSERT INTO `houses` VALUES (1,1,1),(2,NULL,2),(3,2,1),(4,1,2),(5,1,2),(6,2,2);
...
INSERT INTO `renting_tenants` VALUES (1,1),(2,2),(4,3),(3,5);
...
INSERT INTO `reviews` VALUES (2,2,5,'Awesome house!!','2015-10-15'),(5,3,1,'Terrible.','2015-10-15');
...
INSERT INTO `testimonies` VALUES (1,5,'Great staff and great website, I could not be happier renting from you!!','2015-04-04'),(2,5,'Super awesome!','2015-10-15'),(5,4,'I love Pied Piper Property.  David is a cool dude!','2015-10-15');
...
CREATE TABLE `viewing_bookings` (
  ...
  CONSTRAINT `staff_id` FOREIGN KEY (`staff_id`) REFERENCES `houses` (`staff_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `tenant_id` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`tenant_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `viewing.house_id` FOREIGN KEY (`house_id`) REFERENCES `houses` (`house_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `viewing_bookings`
--

LOCK TABLES `viewing_bookings` WRITE;
/*!40000 ALTER TABLE `viewing_bookings` DISABLE KEYS */;
INSERT INTO `viewing_bookings` VALUES (7,2,2,3,'2015-10-18','10:00:00'),(8,1,2,1,'2015-10-22','10:30:00'),(9,1,2,5,'2015-10-25','11:30:00');
/*!40000 ALTER TABLE `viewing_bookings` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `viewing_times` VALUES (1,'Thursday','10:30:00'),(2,'Tuesday','12:00:00'),(3,'Friday','10:00:00'),(4,'Wednesday','10:30:00'),(5,'Sunday','11:30:00'),(6,'Monday','13:00:00');
...
-- Dump completed on 2015-10-18 17:46:10
